        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div class="mt-2 text-gray-500">
                    <div class="flex justify-between">Total Paid: <Price :price="totalPaid" class="font-medium"/></div>
                    <div class="flex justify-between">Principal Paid: <Price :price="listing.price" class="font-medium"/></div>
                    <div class="flex justify-between">Total Interest: <Price :price="totalInterest" class="font-medium"/></div>
                </div>
            </Box>
        </div>
    </div>
