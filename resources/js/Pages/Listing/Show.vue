<template>
    <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
        <Box class="md:col-span-7 flex items-center w-full">
            <div v-if="listing.images.length > 1" class="grid grid-cols-2 gap-1 w-full">
                <img v-for="image in listing.images" :key="image.id" :src="image.src"
                    class="w-full h-auto object-cover" />
            </div>
            <div v-else-if="listing.images.length === 1" class="w-full h-full">
                <img :src="listing.images[0].src" class="w-full h-full object-cover rounded-md" />
            </div>
        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div class="mt-2 text-gray-500">
                    ...
                    <div class="flex justify-between">Principal Paid:
